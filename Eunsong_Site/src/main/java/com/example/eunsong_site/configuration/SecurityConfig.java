package com.example.eunsong_site.configuration;

import com.example.eunsong_site.security.JwtAuthenticationFilter;
import com.example.eunsong_site.security.JwtTokenProvider;
...
/**
 * packageName : com.example.eunsi.configuration
...
//                2) 추가 설정( 권한 설정 : ROLE_USER, ROLE_ADMIN )
                .and()
                .authorizeRequests() // 화면 접근 권한 설정 체크
//                아래 주소로 접근하면 모두 허용
